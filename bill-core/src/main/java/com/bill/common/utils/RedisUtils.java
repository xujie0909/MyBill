...
public class RedisUtils {
     ...
     * @return
     */
    public static Double incrementScore(String key,String item,double score){
        ZSetOperations<String, Object> zset = redisTemplate.opsForZSet();
        return zset.incrementScore(key,item,score);
    }

    /**
     * 获取高分元素
     */
    public static Set<Object> zrevrangebyscore(String key,Double d1,Double d2){
        ZSetOperations<String, Object> zset = redisTemplate.opsForZSet();
        Set<Object> results = zset.rangeByScore(key, d1, d2);
        return results;
    }
     ...
     */
    public static Long rank(String mainKey,String itemKey){
        ZSetOperations<String, Object> zset = redisTemplate.opsForZSet();
        return zset.rank(mainKey, itemKey);
    }
    ...
    public static boolean isMember(String mainKey,String itemKey){
        ...
        return zet.isMember(mainKey, itemKey);
    }
